...
do
    ...
    # Run 
    rgi main \
        --input_sequence ${parent_dir}/${input_dir}/${sample}/scaffolds_summary/scaffolds_plasmid.fna \
        --output_file ${parent_dir}/${output_dir}/${sample}/"rgi_on_genomad_plasmid_seq_${sample}" \
        --local \
        --clean \
        --num_threads 28 \
        --split_prodigal_jobs \
